...
<a href = "#"><img src="img/python.svg" alt="python" style="vertical-align:top; margin:6px 4px; width:10%;"></a> <a href = "#"><img src="img/C++.svg" alt="C++" style="vertical-align:top margin:6px 4px"></a>
